...
trait FileSystemTrait
{
    ...
    public function getContents(string $filename, bool $use_include_path = false, bool $context = true)
    {
         ...
         * @return mixed
         */
        $opts = ActionFilterHook::getInstance()->applyFilter('stream_context_create_options', $opts);
     ...
     * @return void|\Qubus\Exception\Exception
    ...
    public function beautifyFilename(string $filename)
    {
         ...
         */
        $filename = ActionFilterHook::getInstance()->applyFilter('beautified_filename', $filename, $filename_raw);
    ...
    public function sanitizeFilename(string $filename, bool $beautify = true)
    {
         ...
         */
        $filename = ActionFilterHook::getInstance()->applyFilter('sanitized_filename', $filename, $filename_raw);
